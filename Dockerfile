...
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install -y patchelf desktop-file-utils debhelper libleptonica-dev automake libtool libarchive-dev libpango1.0-dev libcairo2-dev libicu-dev libpng-dev libjpeg-dev libtiff-dev zlib1g-dev git asciidoctor ruby-asciidoctor-pdf wget libfuse2 fuse devscripts
